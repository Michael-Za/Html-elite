      ...
      <div className="w-full max-w-md bg-white border border-gray-200 rounded-xl shadow-lg overflow-hidden">
        <div className="p-8 space-y-6">
          ...
          <div className="text-center">
            <h1 className="text-2xl font-bold text-gray-900">Klickbee CRM</h1>
          </div>
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="relative space-y-4">
            ...
            <button
              ...
              className="w-full bg-black hover:bg-gray-800 text-white font-semibold py-2.5 px-6 rounded-lg shadow-lg hover:shadow-xl transform hover:scale-[1.02] transition-all duration-200 disabled:opacity-50 disabled:cursor-not-allowed disabled:transform-none"
            >
...
function Field({
  ...
  return (
    <div className="space-y-2">
      ...
      <input
        {...inputProps}
        className="bg-white border border-gray-300 text-gray-900 placeholder:text-gray-400 w-full px-3 py-2 rounded-lg focus:outline-none focus:ring-2 focus:ring-black focus:border-transparent transition-all duration-200 shadow-sm hover:border-gray-400 disabled:bg-gray-100 disabled:cursor-not-allowed"
      />
